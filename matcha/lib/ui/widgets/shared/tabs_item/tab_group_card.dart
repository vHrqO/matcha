...
class TabGroupCard extends StatelessWidget {
  const TabGroupCard({super.key, required this.tabGroup, required this.hoverMenuBuilder});
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: TabList(tabList: tabGroup.tabList, hoverMenuBuilder: hoverMenuBuilder),
            ),
          ],
        ),
      ),
